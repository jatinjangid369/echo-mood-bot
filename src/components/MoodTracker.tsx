...
const MoodTracker = () => {
  ...
  const moodOptions = [
    ...
    { value: 2, label: "Sad", icon: Frown, color: "text-orange-500", bg: "bg-orange-100" },
    ...
    { value: 5, label: "Very Happy", icon: Star, color: "text-purple-500", bg: "bg-purple-100" },
  ];
                ...
                <button
                  ...
                  className={`p-4 rounded-xl border-2 transition-all duration-200 hover:scale-105 ${
                    selectedMood === mood.value
                      ? `border-${mood.color.split('-')[1]}-400 ${mood.bg} shadow-md`
